...
# -*- coding: utf-8 -*-
"""
Erzeugt das eduki-Deckblatt für KD-15 "Regulations-Mut-O-Mat" im bestehenden
KLARTEXT-Cover-Template (identische Maße/Logik wie build_eduki_covers.py).
"""
...
ACCENT_REGULATION = colors.HexColor("#8B7BA8")  # Flieder/Lavendel - noch unbenutzt
...
def main():
    ...
    build_cover(
        out_dir,
        "KLARTEXT_Cover_RegulationsMutOMat",
        accent_color=ACCENT_REGULATION,
        tagline="Freebie · Himmel-&-Hölle-Faltspiel",
        title_lines=["Regulations-", "Mut-O-Mat"],
        label_text="Für wen",
        description_text="Kinder & OGS-Kids · gemeinsam mit Eltern zu Hause spielen",
        box_label="Inhalt",
        box_text=(
            "Faltspiel-Vorlage mit 4 Brainy-Gefühlen (wütend, alarmiert, traurig, "
            "müde) + passendem Co-Regulations-Tipp und Bastelanleitung."
        ),
