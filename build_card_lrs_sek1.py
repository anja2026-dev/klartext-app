...
# -*- coding: utf-8 -*-
"""
KLARTEXT LRS/Dyskalkulie-Deck – Kartengenerator (adaptiert von build_card_tr.py).
...
# ── Farben (LRS/Dyskalkulie-Deckfarbe: Sandbraun #BF9369 – kollisionsgeprüft (min. Abstand 68,6 zu Werkzeug-Gold #B07D2A).) ──
TR          = (191, 147, 105)       # #BF9369
TR_LIGHT    = (245, 235, 221)     # Hell-Variante
TR_BORDER   = (224, 203, 168)     # Rand-Variante
...
def build_back(card, out_path):
    ...
    nr_text = card.get("id_text", f"L-{card['nr']:02d}")
    ...
    footer_deck = card.get("footer_deck", "LRS/Dyskalkulie-Deck")
