...
# -*- coding: utf-8 -*-
"""
KLARTEXT SMI-Deck – Kartengenerator (adaptiert von build_card_tr.py).
...
# ── Farben (SMI-Deckfarbe: Aubergine-Violett #592D59 – kollisionsgeprüft (min. Abstand 44,4 zu LK-Pflaume #6B4E71).) ──
TR          = (89, 45, 89)       # #592D59
TR_LIGHT    = (238, 227, 238)     # Hell-Variante
TR_BORDER   = (211, 184, 211)     # Rand-Variante
...
def build_front(card, image_path, out_path):
    ...
    badge_text = card.get("badge", "SMI · MOBBING-INTERVENTION")
...
def build_back(card, out_path):
    ...
    nr_text = card.get("id_text", f"SMI-{card['nr']:02d}")
    ...
    footer_deck = card.get("footer_deck", "SMI-Deck")
