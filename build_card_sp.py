...
# -*- coding: utf-8 -*-
"""
KLARTEXT SP-Deck – Kartengenerator (adaptiert von build_card_tr.py).
...
# ── Farben (SP-Deckfarbe: Espresso-Taupe #5A4A42 – kollisionsgeprüft (min. Abstand 37,5 zu Zonen-Graphit #37474F).) ──
TR          = (90, 74, 66)       # #5A4A42
TR_LIGHT    = (237, 230, 226)     # Hell-Variante
TR_BORDER   = (211, 196, 187)     # Rand-Variante
...
def build_back(card, out_path):
    ...
    nr_text = card.get("id_text", f"SP-{card['nr']:02d}")
    ...
    footer_deck = card.get("footer_deck", "SP-Deck")
