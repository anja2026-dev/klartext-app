...
- ✅ **Gefixt (11.09.2026, Folgesession):** Root Cause war target="_blank" auf den Vorschlags-Links (Perspektiv-Wechsler, Reizfilter, Interessen-Check, Bewerbungsgespräch) — neuer Tab übernahm den Login-Status nicht zuverlässig (v. a. Safari). Fix: Links öffnen jetzt im selben Tab. Zusätzlich fehlende Gast-Zugriffs-Ausnahme bei Interessen-Check/Bewerbungsgespräch ergänzt (gleiches ?guest=true-Muster wie Reizfilter/Perspektiv-Wechsler); Gast-Status wird jetzt an die Tool-Links weitergegeben. Commit 572dfd1.
- ✅ **Gefixt (mit demselben Commit):** Zurück-Navigation bei den Karten — war Folgefehler desselben target="_blank"-Problems, löst sich mit demselben Fix.
- ✅ **Gefixt (mit demselben Commit):** Ressourcenbericht-Link zeigt jetzt direkt auf `KLARTEXT_Ressourcenbericht_Jugendliche.html` statt auf die allgemeine Auswahlseite mit der unpassenden OGS-Option.
